...
(function ($) {
	...
	$.fn.shorten = function() {
		...
		return this.each(function () {
            ...
            var tmp_data = $this.attr('data-text') ? $this.attr('data-text') : text;
            options.tail = "..." + tmp_data.substring((tmp_data.length - 7), tmp_data.length);
            tailText = $("<span/>").html(options.tail).text();
